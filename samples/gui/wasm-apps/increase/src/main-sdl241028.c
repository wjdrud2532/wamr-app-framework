...
// //     // SDL 창 생성
    ...
    printf("window pointer: %p\n", window);
    // printf("window value : %d\n", *window);
    window = (uint32)window & 0xFFFF;
    printf("window pointer: %p\n", window);
    printf("window value : %d\n", *window);
...
// printf("SDL_Surface 초기화 전\n");
//         SDL_Surface* screenSurface = SDL_GetWindowSurface(window);
// printf("SDL_Surface 비트마스킹\n");
//         screenSurface = (uint32)screenSurface & 0xFFFF;
// printf("SDL_Surface 초기화 후\n");
...
printf("renderer pointer %p\n", renderer);
  renderer = (uint32)renderer & 0xFFFF;
